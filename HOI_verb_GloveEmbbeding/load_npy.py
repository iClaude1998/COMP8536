...
LastEditTime: 2022-10-16 23:58:11
...
if __name__ == "__main__":
    ...
    wordVectors = np.load(f'{root_dir}/finetuned_HOI_Verb_wordVectors_normed.npy')
    print(wordVectors)
    # norm = np.linalg.norm(wordVectors, axis=1)
    # wordVectors = wordVectors / norm.reshape(-1, 1)
    # print(wordVectors)
    # np.save('HOI_verb_GloveEmbbeding/finetuned_HOI_Verb_wordVectors_normed.npy', wordVectors)
